...
axes3d.xaxis.set_major_formatter(FuncFormatter(to_zoomX1))#将X,Y,Z轴的坐标轴放大50倍
...
axes3d.set_xlabel('reward_for_success',fontsize=12, fontweight="bold")
axes3d.set_ylabel('reward_for_fail',fontsize=12, fontweight="bold")
axes3d.set_zlabel('ave turns',fontsize=12, fontweight="bold")
plt.savefig("3D_Histogram.pdf")
plt.show()