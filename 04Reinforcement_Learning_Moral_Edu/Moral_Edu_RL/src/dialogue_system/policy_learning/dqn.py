...
class DQN1(object):
    ...
    def __build_model(self):
        ...
        if self.parameter.get("train_mode") != 1:
            ...
            print(tf.train.latest_checkpoint(self.parameter.get('checkpoint_path')))
            print('@@@@@@2019821@@@@@@@@@@', self.parameter.get("saved_model"))
            # self.restore_model(self.parameter.get("saved_model"))
            self.restore_model(tf.train.latest_checkpoint(self.parameter.get('checkpoint_path')))
