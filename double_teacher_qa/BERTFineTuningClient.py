...
from bert_fine_tuning.predict_demo import predict_test
from utils import replace_punctuation
import Levenshtein
from search_solr.solr import search_by_keywords

def sorl_bert_finetuning_query(input_text):
    '''
...
if __name__ == '__main__':
    ...
    testQ = ['打架']
    for que in testQ:
        # sorl_bert_finetuning_query(que)
        print('------------------------------------------------------')
        solr_only(que)
