...
data_path = './../../data_split/physical_split0422.xls'
base_dir = './../../data/preprocess_result_physical'
normal_sheet_idx = 2
'''
...
def clean_ques_desc(ques_desc):
    ...
    ques_desc = re.sub(r'^\((.*?)\)', '', ques_desc)
    # 6替换一些不规则信息
    ques_desc = ques_desc.replace('（2016.丰台一模）', '').replace('2016丰台九上期末', '') \
...
if __name__ == '__main__':
    print('start preprocess physical data...')
    get_data(data_path)
    print('end...')
